...
Nexus stores everything in a SQLite database in your home directory. Your API keys are encrypted locally. Your conversations never leave your machine unless you explicitly connect a channel adapter. That's a deliberate choice, and it's one I'd make again.
