...
The scoring wasn't even close. The existing system scored below three out of five on every dimension. A clean design, informed by everything I'd learned from the first attempt, scored above four and a half. The analysis didn't just justify the rewrite. It gave me a blueprint for what to build.
...
There's a version of this project that's a SaaS product. Multi-tenant, subscription model, managed infrastructure. I built the opposite on purpose.
