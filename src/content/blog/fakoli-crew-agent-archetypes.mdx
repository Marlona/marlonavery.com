...
I use fakoli-crew most heavily when working on the plugin marketplace itself. The irony isn't lost on me: the plugin that manages plugins is maintained by agents specialized in plugin work.
